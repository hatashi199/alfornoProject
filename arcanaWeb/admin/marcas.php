...
<div class="xs100 flex xs_jcCenter">
    <div class="centrado flex xs_fCol xs_aiCenter">
        <div class="xs100 flex xs_fCol xs_aiCenter fondoBlanco formControl mTop40 mBottom40">
            <h2 class="mBottom40">Listado de Marcas</h2>
                ...
                ?>
                    ...
                    <div class="xs100 flex xs_jcSpabet xs_aiCenter mBottom20">
                        ...
                        <div class="m10 flex xs_jcSpabet xs_aiCenter linkEd_Borr">
                            <a href="edMarca.php?imar=<?php echo $row1['id_marca']?>"><i class="fas fa-edit"></i></a>
                            <a href="delMarca.php?imar=<?php echo $row1['id_marca']?>" class="delElemento"><i class="far fa-trash-alt"></i></a>
                        </div>
                    </div>
            ...
            <div class="fondoCian linkAzul"><a href="nMarca.php">Añadir Marca</a></div>
        </div>
