    ...
    <script>
        ...
        <div class="xs100 flex xs_jcCenter fondoBlanco pTop20 pBottom20 filtroControl mTop40">
            <?php
                ...
                if(isset($_GET['ordenControl2'])) {
                    $_SESSION['ordenControl2'] = $_GET['ordenControl2'];
                }
                ...
                if(isset($_GET['filtroMarca'])) {
                    $_SESSION['filtroMarca']=$_GET['filtroMarca'];
                }
            ?>
            <form action="index.php" method="get" id="formListado" class="xs70 flex xs_jcCenter xs_jcSpabet">
                <select name="filtroCategoria" class="ordenLista">
                ...
                <select name="filtroMarca" class="ordenLista">
                    <option value="0" <?php if ((isset($_SESSION['filtroMarca']))&&($_SESSION['filtroMarca']==0)) echo "selected"?>>Todas las Marcas</option>
                    <?php
                        $sql2 = "select * from marcas";
                        $resul2 = $db->query($sql2);
                        while ($row2 = $resul2->fetch_assoc()) {
                            if ((isset($_SESSION['filtroMarca']))&&($_SESSION['filtroMarca']==$row2['id_marca'])) {
                    ?>

                    <option value="<?php echo $row2['id_marca']?>" selected><?php echo $row2['nombre']?></option>
                ...
                <select name="ordenControl1" class="ordenLista">
                ...
                <select name="ordenControl2" class="ordenLista">
                    <option value="0" <?php if ((isset($_SESSION['ordenControl2']))&&($_SESSION['ordenControl2']==0)) {echo "selected";}?>>10</option>
                    <option value="1" <?php if ((isset($_SESSION['ordenControl2']))&&($_SESSION['ordenControl2']==1)) {echo "selected";}?>>15</option>
                    <option value="2" <?php if ((isset($_SESSION['ordenControl2']))&&($_SESSION['ordenControl2']==2)) {echo "selected";}?>>20</option>
                    <option value="3" <?php if ((isset($_SESSION['ordenControl2']))&&($_SESSION['ordenControl2']==3)) {echo "selected";}?>>25</option>
                </select>
            </form>
            <span></span>
        </div>
        <div class="centrado flex xs_fCol xs_aiCenter fondoBlanco formControl mTop40 mBottom40">
            ...
            <div class="xs90 flex xs_fCol mBottom20">
                <?php
                    $sql1 = "select c.nombre as categoria,p.*,m.nombre as marca from categorias c left join productos p 
                    ...
                    if(isset($_SESSION['filtroMarca'])) {
                        if ($_SESSION['filtroMarca']==0) {
                            $sql1 = $sql1;
                        } else {
                            $sql1 = $sql1.$condicion."p.id_marca=".$_SESSION['filtroMarca'];
                            $condicion = " and ";
                        }
                    }
                    ...
                    if ($_SESSION['ordenControl2']==0) {
                        $numElementos = 10;
                    } elseif ($_SESSION['ordenControl2']==1) {
                        $numElementos = 15;
                    } elseif ($_SESSION['ordenControl2']==2) {
                        $numElementos = 20;
                    } elseif ($_SESSION['ordenControl2']==3) {
                        $numElementos = 25;
                    }
                ...
                ?>
                    ...
                    <div class="xs100 flex xs_jcSpabet xs_aiCenter mBottom20">
                        <div class="overhide xs10 controlImg"><a href="../images/productosImg<?php echo $row1['imagen']?>" style="display: block;" class="lightbox"><img src="../images/productosImg<?php echo $row1['imagen']?>" alt="imagenProducto" class="xs100" style="display: block;"></a></div>
                        <h3><?php echo $row1['nombre']?></h3>
                        <div class="m10 flex xs_jcSpabet xs_aiCenter linkEd_Borr">
                            <a href="edProducto.php?iprod=<?php echo $row1['id_producto']?>"><i class="fas fa-edit"></i></a>
                            <a href="delProducto.php?iprod=<?php echo $row1['id_producto']?>" class="delElemento"><i class="far fa-trash-alt"></i></a>
                        </div>
                    </div>
            ...
            <div class="fondoCian linkAzul"><a href="nProducto.php">Añadir Producto</a></div>
        </div>
