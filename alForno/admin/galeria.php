...
<div class="xs100 flex xs_jcCenter">
    <div class="centrado flex xs_fCol xs_aiCenter">
        <div class="xs100 flex xs_fCol xs_aiCenter fondoBlanco formControl mTop40 mBottom40">
            <h2 class="mBottom40 txNegro">Galería de fotos</h2>
            <div class="xs90 flex xs_fCol xs_aiStart mBottom20">
                <?php
                    ...
                    if(isset($_SESSION['palabraControl'])) {
                        $sql1 = $sql1.$condicion." tx_alternativo like '%".$_SESSION['palabraControl']."%'";
                    }
                    ...
                    if($resul1->num_rows==0){
                        echo "<h3 class='xs100 txCentrado txNegro mBottom40 mTop40'>No existen productos con los filtros asignados</h3>";
                    }
                    while ($row1 = $resul1->fetch_assoc()) {
                ?>

                    <div class="xs100 flex xs_jcSpabet xs_aiCenter mBottom20">
                    <div class="imgGaleria fondoImgCentrado" style="background-image: url(../images<?php echo $row1['foto']?>);"></div>
                        <div class="m10 flex xs_jcEnd xs_aiCenter linkEd_Borr">
                            <a href="delGaleria.php?igal=<?php echo $row1['id_foto']?>" class="delElemento"><i class="far fa-trash-alt"></i></a>
                        </div>
                    </div>
            ...
            <div><a href="nGaleria.php" class="botonRojo">Añadir Foto</a></div>
        </div>
